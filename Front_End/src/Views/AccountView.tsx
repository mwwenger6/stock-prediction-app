                    ...
                    <div className="row">
                        <div className="col-lg-6 col-12">
                            ...
                            <div className="d-flex align-items-center">
                                <h3>Password:</h3>
                                <h4 className="fw-light ms-3">{props.user.password}</h4>
                            </div>
                        </div>
                        <div className="col-lg-6 col-12">
                            <div className="d-flex align-items-center">
                            ...
                            <div className="d-flex align-items-center">
                                <h3>Sign Up Date:</h3>
                                <h4 className="fw-light ms-3">{new Date(props.user.createdAt).toLocaleDateString('en-US', { weekday: 'short', year: 'numeric', month: 'long', day: 'numeric' })}</h4>
                            </div>
                        </div>
                    </div>
                </div>
